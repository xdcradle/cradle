...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (!status) {
                alert('检测到您的浏览器无法写入cookie，请更改浏览器隐私级别为高以下。');
            }
...
<div id="header">
    <div id="logo">
    	<a class="logohref" target="_blank" href="#"><img src="images/logo.png" width="140" height="60" alt="摇篮网" /></a>
    </div>
    <div id="BodyHeader_displaylogin">
 	<span class="gray login_text"> 已有账号？直接&nbsp;<a href="login.jsp"  class="noline ml5">登录</a></span>
    </div>
</div>
						...
						<tbody>
							<tr>
								<td>
									...
									<span class="hide hint">英文、数字、汉字或下划线，2-12位，不区分大小写</span>
							...
							<tr>
								<td>
									...
									<span class="hint hide">英文、数字或符号，6-20位，区分大小写:</span>
							...
							<tr>
                                <td>
									...
									<span class="hint hide">为保持密码的准确性，请再次输入密码</span>
								</td>
							</tr>	
							<tr>
								<td style="z-index:2;">
                  ...
                  <div class="spread_video">
					...
					<div class="post_box">
						...
						if(errmsg!=null)
							out.print(errmsg);
					 	%></span>
                        <input value="立即注册" id="reg_button" type="submit" />                   
                    </div>                    
					<div class="clear"></div>
                    <div class="spread_video_box">
                        ...
                        <p>
                            <span class="fr mt5">
                                ...
                                <a class="gray noline close_spread_video" href="#1">收起</a>
...
<div id="footer">
					...
					<div class="footer_content">
						<div style="height: 30px;">
							<span class="fl">
								<a href="#" target="_blank" class="noline">问题反馈</a>
								-
								<a href="#" target="_blank" class="noline">帮助说明</a>
								-
								<a href="#" target="_blank" class="noline">关于摇篮</a>
								-
								<a href="#" target="_blank" class="noline">联系我们</a>
							</span>
							<span class="fr">
								Copyright 2013 <a href="#" target="_blank" class="noline">摇篮网</a>
							</span>
							<div class="clear"></div>
						</div>
					</div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#mail').mailAutoComplete({
                boxClass: "mail_out_box", 	//外部box样式
                listClass: "mail_list_box", 	//默认的列表样式
                focusClass: "mail_focus_box", //列表选样式中
                markCalss: "mail_mark_box", 	//高亮样式
                autoClass: true,
                zIndex: 999,
                choseText: '请选择您的邮箱类型',
                callback: function () {
        ...
        function bindValidate() {
            ...
            $("form").validate({
                ...
                messages: {
                    name: {
                        required: "2-12位，字母，数字，下划线，中文，不允许标点符号",
                        isnum: '用户名应至少包含一个字母或汉字',
                        punctuation_char: "请勿使用除字母 (a-z)、数字、汉字和下划线以外的其他字符",
                        space_check: "请勿使用除字母 (a-z)、数字、汉字和下划线以外的其他字符",

                        minlength: '请至少使用2个字符。',
                        name_format_check: "2-12位，字母，数字，下划线，中文，不允许标点符号。",
                        remote: "用户名已存在，你可以给用户名加上数字或年份后缀"
                    },
                    password: {
                        required: "可输入6-20位，包含英文、数字和符号，不允许空格",
                        minlength: "为保证密码的安全性，请至少使用 6 个字符",
                        space_check: "不允许有空格",
                        check_password: "密码不能与用户名相同",
                        check_weakpassword: "请不要使用弱密码"
                    },
                    re_password: {
                        required: "可输入6-20位，包含英文、数字和符号，不允许空格",
                        minlength: "为保证密码的安全性，请至少使用 6 个字符",
